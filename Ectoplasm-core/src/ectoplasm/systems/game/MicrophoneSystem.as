package ectoplasm.systems.game
{
	...
	public class MicrophoneSystem extends ListIteratingSystem
	{
		...
		public function MicrophoneSystem()
		{
			super(MicrophoneNode,onUpdate);
		}
		...
		override public function addToEngine( engine : Engine ) : void
		{
			...
			if (mic) {
				...
				var t:SoundTransform = mic.soundTransform;
				t.volume = 0;
				mic.soundTransform = t;
		...
		public function onUpdate(node:MicrophoneNode, time:Number):void
		{			
			if(!mic) return;
			...
			node.mic.activityLevel = mic.activityLevel/100;
		}
	}
}